...
var handlers = {
    'LaunchRequest': function() { 
     ...
     'LaunchIntent': function() {
        if (!this.attributes['ScoreCount']){
            speechOutput = "Hi, welcome to Jump Numbers game. Here are the instructions for the game - In easy mode, you have to speak out 'jump' word on multiples of 5 and similary in medium, 3 and 7 multiples and in complex 4, 7 and 9. Remember you have to say pass if number is not a multiple. Every jump will give +5 points, every pass will give you +1 points and after 25 points level increases. After 2 levels upgrade you will earn a Batch as well. To begin the game, please tell me your mode of play.";
            ...
            this.emit(':askWithCard', speechOutput, reprompt, cardTitle, cardContent, imageObj);
                ...
                speechOutput = "Hi, Welcome back to Jump Numbers game. I can still remember your previous score is " + this.attributes['ScoreCount'] + " , level is " + this.attributes['Level'] + ((this.attributes['Level'] >= 2) ? " and you have badge titled " + this.attributes['Badge'] : "") + ". To begin the game, please tell me your mode of play.";
                reprompt = "Please, tell me your mode of play easy, medium or complex.";
    ...
    'PlayIntent': function() {
        ...
        var check = this.attributes['myJumper'].match(/^jump|pass|next|easy|normal|medium|ok|complex|hard|difficult|yes|no/ui);
        ...
        switch (check[0].toLowerCase()){
            ...
            case 'next':
            case 'jump':
                if(this.attributes['gameMode'] == 'easy' || this.attributes['gameMode'] == 'normal')
                    this.emit('EasyGameIntent');
                else if(this.attributes['gameMode'] == 'medium' || this.attributes['gameMode'] == 'ok')
                    this.emitWithState('MediumGameIntent');
                else if(this.attributes['gameMode'] == 'complex' || this.attributes['gameMode'] == 'hard' || this.attributes['gameMode'] == 'difficult')
                    this.emitWithState('HardGameIntent');                      
                else
                    this.emit(':ask', "Please enter mode of game easy, medium or complex.");
                break;
            default:
    ...
    'EasyGameIntent' : function(){
        ...
        if (multiplier % 5 == 0 && multiplier > 0){
            if(input == 'jump'){
                speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/Jump_Custom.mp3'/> You Got it right, Play again for more fun!!! Do you wanna play again?";
                cardTitle = 'Gotcha';
                ...
                speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/GameOver_ACustom.mp3'/> You have to say jump on multiples of 5. Game over!!! Do you wanna play again?";
            ...
            speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/GameOver_ACustom.mp3'/> You have to say pass if its not a multiple of 5. Game over!!! Do you wanna play again?";
            cardTitle = 'Game Over';
       ...
       'MediumGameIntent' : function(){
        ...
        if (((multiplier % 3 == 0) || (multiplier % 7 == 0)) && multiplier > 0){
            if(input == 'jump'){
                ...
                speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/GameOver_ACustom.mp3'/> You have to say jump on multiples of 3 and 7 both. Game over!!! Do you wanna play again?";
                cardTitle = 'Multiplier is here';
                cardContent = 'Identify the multiplier number';
                reprompt = "Find multiplier number";
        ...
        else if((input != 'pass') && ((multiplier % 3 != 0) || (multiplier % 7 != 0) || (multiplier == 0))){
            speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/GameOver_ACustom.mp3'/> You have to say pass if its not a multiple of 3 and 7 both. Game over!!! Do you wanna play again?";
            cardTitle = 'Game Over';
            cardContent = 'Better Luck next time';
            reprompt = "Try Again...";
    ...
    'HardGameIntent' : function(){
        ...
        if (((multiplier % 4 == 0) || (multiplier % 7 == 0) || (multiplier % 9 == 0)) && multiplier > 0){
            if(input == 'jump'){
                speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/Jump_Custom.mp3'/> You Got it right, Play again for more fun!!! Do you wanna play again?";
                cardTitle = 'Gotcha';
                cardContent = 'You found it';
                ...
                speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/GameOver_ACustom.mp3'/> You have to say jump on multiples of 4, 7 and 9. Game over!!! Do you wanna play again?";
                cardTitle = 'Multiplier is here';
                cardContent = 'Identify the multiplier number';
                reprompt = "Find multiplier number";
        ...
        else if((input != 'pass') && ((multiplier % 4 != 0) || (multiplier % 7 != 0) || (multiplier % 9 != 0) || (multiplier == 0))){
            speechOutput = "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/GameOver_ACustom.mp3'/> You have to say pass if its not a multiple of 4, 7 and 9. Game over!!! Do you wanna play again?";
            cardTitle = 'Game Over';
            cardContent = 'Better Luck next time';
            reprompt = "Try Again...";
    ...
    'AMAZON.HelpIntent': function () {    
        speechOutput = "You can play this game in three modes easy, medium and complex. In easy mode, you have to speak out 'jump' word on multiples of 5 and similary in medium, 3 and 7 multiples and in complex 4, 7 and 9 multiples. Remember you have to say pass if number is not a multiple. Every jump will give +5 points, every pass will give you +1 points and after 25 points level increases. After 2 levels upgrade you will earn a Batch as well. To continue, please answer the previous question.";
