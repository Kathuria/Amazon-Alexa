...
var handlers = {
  ...
  LaunchIntent: function() {
    userInGamePlay = false;
    if (!this.attributes["ScoreCount"]) {
      speechOutput =
        "Hi, Welcome to Jump Numbers game. Here are the instructions for the game - In easy mode, you have to speak out 'jump' word on multiples of 5 and similary in normal, 3 and 7 multiples and in complex 4, 7 and 9. Remember you have to say pass if number is not a multiple. Every jump will give +5 points, every pass will give you +1 points and after 25 points level increases. After 2 levels upgrade you will earn a Batch as well. To begin the game, please tell me your mode of play.";
      reprompt = "Please, tell me your mode of play easy, normal or complex.";
    ...
    switch (check[0].toLowerCase()) {
      ...
      default:
        if (userInGamePlay) {
          this.emit(
            ":ask",
            "Sorry, I did not understand what you said. Please say, Pass or Jump."
          );
        } else {
          this.emit(
            ":ask",
            "Sorry, I did not understand what you said. Please choose mode of play, Easy, Normal or Complex."
          );
        }
    }
  },
  ...
  GameIntent: function() {
    ...
    if (userJumped) {
      ...
      this.emit(
        ":askWithCard",
        "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/GameOver_ACustom.mp3'/>" +
          customOutput +
          " You have " +
          (3 - lives) +
          " life remaining, Game is on. Next Number is " +
          speechOutput,
        reprompt,
        cardTitle,
        cardContent,
  ...
  EasyGameIntent: function() {
    ...
    if (multiplier % 5 == 0 && multiplier > 0) {
      if (input == "jump") {
        ...
        customOutput = "You have to say jump on multiples of 5.";
        userFailed = true;
        ++lives;
        if (userFailed && lives >= 3) {
          speechOutput =
      ...
      customOutput = "You have to say pass if its not a multiple of 5.";
      userFailed = true;
      ++lives;
  ...
  MediumGameIntent: function() {
    ...
    if ((multiplier % 3 == 0 || multiplier % 7 == 0) && multiplier > 0) {
      if (input == "jump") {
        ...
        customOutput = "You have to say jump on multiples of 3 and 7 both.";
        userFailed = true;
        ++lives;
      ...
      customOutput =
        "You have to say pass if its not a multiple of 3 and 7 both.";
      userFailed = true;
      ++lives;
  ...
  HardGameIntent: function() {
    ...
    if (
      ...
      if (input == "jump") {
        ...
        customOutput = "You have to say jump on multiples of 4, 7 and 9.";
        userFailed = true;
        ++lives;
      ...
      customOutput =
        "You have to say pass if its not a multiple of 4, 7 and 9.";
      userFailed = true;
      ++lives;
  ...
  "AMAZON.HelpIntent": function() {
    speechOutput =
      "You can play this game in three modes easy, normal and complex. In easy mode, you have to speak out 'jump' word on multiples of 5 and similary in normal, 3 and 7 multiples and in complex 4, 7 and 9 multiples. Remember you have to say pass if number is not a multiple. Every jump will give +5 points, every pass will give you +1 points and after 25 points level increases. After 2 levels upgrade you will earn a Batch as well. To continue, please answer the previous question.";
