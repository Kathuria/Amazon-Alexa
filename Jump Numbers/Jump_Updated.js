...
var handlers = {
  ...
  PlayIntent: function() {
    ...
    switch (check[0].toLowerCase()) {
      ...
      default:
        this.emit(
          ":ask",
          "Sorry, I did not understand what you said. Say Jump or Pass"
        );
    }
  },
  ...
  EasyGameIntent: function() {
    ...
    if (multiplier % 5 == 0 && multiplier > 0) {
      if (input == "jump") {
        speechOutput =
          "<audio src='https://s3-eu-west-1.amazonaws.com/aksongs/Shoot_Score_Songs/Jump_Custom.mp3'/> You Got it right, Play again for more fun!!! Do you wanna play again?";
        cardTitle = "Gotcha";
